...
description: Use when working with GitHub Actions workflows, CI/CD pipelines, release automation, deployment jobs, caching, permissions, secrets, or failed workflow logs.
model: inherit
---
