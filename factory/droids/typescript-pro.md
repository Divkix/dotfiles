---
name: typescript-pro
description: Use when working with TypeScript, JavaScript, Astro, vinext, SvelteKit, Cloudflare Workers app code, types, validation, tests, build issues, or frontend/backend TypeScript architecture.
model: inherit
---
