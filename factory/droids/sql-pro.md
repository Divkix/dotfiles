---
name: sql-pro
description: Use when working with SQL, schema design, D1/SQLite, PostgreSQL, Drizzle, Supabase, migrations, query optimization, indexes, transactions, or data modeling.
model: inherit
---
