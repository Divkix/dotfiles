---
name: rust-pro
description: Use when working with Rust code, CLI tools, systems programming, async Rust, ownership/lifetime issues, error handling, Cargo, WebAssembly, performance, or safety-sensitive code.
model: inherit
---
