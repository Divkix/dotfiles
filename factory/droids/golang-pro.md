---
name: golang-pro
description: Use when working with Go code, CLIs, services, concurrency, goroutines, channels, context propagation, testing, performance, GoReleaser, Docker builds, or Go module issues.
model: inherit
---
